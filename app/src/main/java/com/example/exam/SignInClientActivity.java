...
public class SignInClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(SignInClientActivity.this, MapClientActivity.class));
        }
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(SignInClientActivity.this,
    ...
    public void toggleLoginMode(View view) {
        ...
        if (loginModeActive) {
            ...
            repeatPasswordEditText.setVisibility(VISIBLE);

        } else {
            loginModeActive = true;
            loginSignUpButton.setText("Log In");
            toggleLoginSignUpTextView.setText("Or, sign up");
            repeatPasswordEditText.setVisibility(GONE);
        }
