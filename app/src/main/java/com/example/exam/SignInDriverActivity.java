...
public class SignInDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginSignUpButton.setOnClickListener(new OnClickListener() {
            @Override
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(SignInDriverActivity.this, MapDriverActivity.class));
        }
